-- Fix the type casting issues and implement all features
...
-- Create storage policies for file uploads (fixed type casting)
...
-- Project files policies with organization access
